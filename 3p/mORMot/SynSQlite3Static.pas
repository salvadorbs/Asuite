...
function sqlite3_key(DB: TSQLite3DB; key: pointer; keyLen: Integer): integer; {$ifndef USEFASTCALL}cdecl;{$endif}
var Cyph: TSQLCypher;
...
function sqlite3_rekey(DB: TSQLite3DB; key: pointer; keyLen: Integer): integer; {$ifndef USEFASTCALL}cdecl;{$endif}
begin
...
function sqlite3_closeInternal(DB: TSQLite3DB): integer; {$ifndef USEFASTCALL}cdecl;{$endif}
var i: integer;
begin
  if Cyphers<>nil then
...
function sqlite3_create_module_v2(DB: TSQLite3DB; const zName: PAnsiChar;
  var p: TSQLite3Module; pClientData: Pointer; xDestroy: TSQLDestroyPtr): Integer; {$ifndef USEFASTCALL}cdecl;{$endif} external;
function sqlite3_declare_vtab(DB: TSQLite3DB; const zSQL: PAnsiChar): Integer; {$ifndef USEFASTCALL}cdecl;{$endif} external;
...
function sqlite3_rollback_hook(DB: TSQLite3DB;  xCallback: TSQLCommitCallback;
  pArg: Pointer): Pointer; {$ifndef USEFASTCALL}cdecl;{$endif} external;
function sqlite3_changes(DB: TSQLite3DB): Integer; {$ifndef USEFASTCALL}cdecl;{$endif} external;
function sqlite3_total_changes(DB: TSQLite3DB): Integer; {$ifndef USEFASTCALL}cdecl;{$endif} external;
function sqlite3_malloc(n: Integer): Pointer; {$ifndef USEFASTCALL}cdecl;{$endif} external;
function sqlite3_realloc(pOld: Pointer; n: Integer): Pointer; {$ifndef USEFASTCALL}cdecl;{$endif} external;
procedure sqlite3_free(p: Pointer); {$ifndef USEFASTCALL}cdecl;{$endif} external;
function sqlite3_memory_used: Int64; {$ifndef USEFASTCALL}cdecl;{$endif} external;
function sqlite3_memory_highwater(resetFlag: Integer): Int64; {$ifndef USEFASTCALL}cdecl;{$endif} external;
