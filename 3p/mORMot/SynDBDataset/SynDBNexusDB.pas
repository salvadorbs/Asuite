...
const CONV_TABLE: array[TnxFieldType] of TSQLDBFieldType  = (
  SynDB.ftInt64, SynDB.ftUTF8, SynDB.ftUTF8, SynDB.ftInt64, SynDB.ftInt64,
  SynDB.ftInt64, SynDB.ftInt64, SynDB.ftInt64, SynDB.ftInt64, SynDB.ftInt64,
  SynDB.ftInt64, SynDB.ftDouble, SynDB.ftDouble, SynDB.ftDouble,
  SynDB.ftCurrency, SynDB.ftDate, SynDB.ftDate, SynDB.ftDate, SynDB.ftInt64,
  SynDB.ftBlob, SynDB.ftUTF8, SynDB.ftBlob, SynDB.ftBlob, SynDB.ftUTF8,
  SynDB.ftUTF8, SynDB.ftUTF8, SynDB.ftInt64, SynDB.ftUTF8, SynDB.ftCurrency,
  SynDB.ftUTF8, SynDB.ftDouble );
begin
...
procedure TSQLDBNexusDBStatement.DatasetPrepare(const aSQL: string);
begin
