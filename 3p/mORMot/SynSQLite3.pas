...
type
  ...
  TSQLite3Module = record
    ...
    xCreate: function(DB: TSQLite3DB; pAux: Pointer;
      ...
      var ppVTab: PSQLite3VTab; var pzErr: PUTF8Char): Integer; {$ifndef USEFASTCALL}cdecl;{$endif}
  ...
  public
    ...
    initialize: function: integer; {$ifndef USEFASTCALL}cdecl;{$endif}

    {/ shutdown the SQLite3 database core
      - automaticaly called by the finalization block of this unit }
    shutdown: function: integer; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    open: function(filename: PUTF8Char; var DB: TSQLite3DB): integer; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    key: function(DB: TSQLite3DB; key: pointer; keyLen: Integer): integer; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    rekey: function(DB: TSQLite3DB; key: pointer; keyLen: Integer): integer; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    errmsg: function(DB: TSQLite3DB): PAnsiChar; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    create_collation: function(DB: TSQLite3DB; CollationName: PUTF8Char;
      StringEncoding: integer; CollateParam: pointer; cmp: TSQLCollateFunc): integer; {$ifndef USEFASTCALL}cdecl;{$endif}

    {/ Returns the rowid of the most recent successful INSERT into the database }
    last_insert_rowid: function(DB: TSQLite3DB): Int64; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    {/ Set A Busy Timeout
     ...
     -  There can only be a single busy handler for a particular database connection
      ...
      is cleared. }
    busy_timeout: function(DB: TSQLite3DB; Milliseconds: integer): integer; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    busy_handler: function(DB: TSQLite3DB;
      CallbackPtr: TSQLBusyHandler; user: Pointer): integer;  {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    prepare_v2: function(DB: TSQLite3DB; SQL: PUTF8Char; SQL_bytes: integer;
      var S: TSQLite3Statement; var SQLtail: PUTF8Char): integer; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    finalize: function(S: TSQLite3Statement): integer; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    next_stmt: function(DB: TSQLite3DB; S: TSQLite3Statement): TSQLite3Statement; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    reset: function(S: TSQLite3Statement): integer; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    stmt_readonly: function(S: TSQLite3Statement): boolean; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    step: function(S: TSQLite3Statement): integer; {$ifndef USEFASTCALL}cdecl;{$endif}

    {/ number of columns in the result set for the statement }
    column_count: function(S: TSQLite3Statement): integer; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    column_type: function(S: TSQLite3Statement; Col: integer): integer; {$ifndef USEFASTCALL}cdecl;{$endif}

    {/ returns a zero-terminated UTF-8 string containing the declared datatype of a result column }
    column_decltype: function(S: TSQLite3Statement; Col: integer): PAnsiChar; {$ifndef USEFASTCALL}cdecl;{$endif}

    {/ returns the name of a result column as a zero-terminated UTF-8 string }
    column_name: function(S: TSQLite3Statement; Col: integer): PUTF8Char; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    column_bytes: function(S: TSQLite3Statement; Col: integer): integer; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    column_value: function(S: TSQLite3Statement; Col: integer): TSQLite3Value; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    column_double: function(S: TSQLite3Statement; Col: integer): double; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    column_int: function(S: TSQLite3Statement; Col: integer): integer; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    {/ converts the Col column in the current row prepared statement S
      ...
      - FLOAT is truncated into corresponding integer value
      - TEXT or BLOB is converted from all correct ASCII numbers with 0 as default }
    column_int64: function(S: TSQLite3Statement; Col: integer): int64; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    column_text: function(S: TSQLite3Statement; Col: integer): PUTF8Char; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    column_blob: function(S: TSQLite3Statement; Col: integer): PAnsiChar; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    {/ datatype code for a sqlite3.value object, specified by its handle
      ...
      - must be called before any sqlite3.value_*() statement, which may result in
       an implicit type conversion: in this case, value is undefined }
    value_type: function(Value: TSQLite3Value): integer; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    {/ attempts to apply numeric affinity to the value
      ...
      - returned value is one of SQLITE_INTEGER, SQLITE_FLOAT, SQLITE_TEXT,
       SQLITE_BLOB or SQLITE_NULL }
    value_numeric_type: function(Value: TSQLite3Value): integer; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    value_bytes: function(Value: TSQLite3Value): integer; {$ifndef USEFASTCALL}cdecl;{$endif}

    {/ converts a sqlite3.value object, specified by its handle,
      into a floating point value and returns a copy of that value }
    value_double: function(Value: TSQLite3Value): double; {$ifndef USEFASTCALL}cdecl;{$endif}

    {/ converts a sqlite3.value object, specified by its handle,
      into an integer value and returns a copy of that value }
    value_int64: function(Value: TSQLite3Value): Int64; {$ifndef USEFASTCALL}cdecl;{$endif}

    {/ converts a sqlite3.value object, specified by its handle,
      into an UTF-8 encoded string, and returns a copy of that value }
    value_text: function(Value: TSQLite3Value): PUTF8Char; {$ifndef USEFASTCALL}cdecl;{$endif}

    {/ converts a sqlite3.value object, specified by its handle,
      into a blob memory, and returns a copy of that value }
    value_blob: function(Value: TSQLite3Value): pointer; {$ifndef USEFASTCALL}cdecl;{$endif}


    {/ sets the return value of the application-defined function to be NULL}
    result_null: procedure(Context: TSQLite3FunctionContext); {$ifndef USEFASTCALL}cdecl;{$endif}

    {/ sets the return value of the application-defined function to be the 64-bit
       signed integer value given in the 2nd argument }
    result_int64: procedure(Context: TSQLite3FunctionContext; Value: Int64); {$ifndef USEFASTCALL}cdecl;{$endif}

    {/ sets the result from an application-defined function to be a floating point
      value specified by its 2nd argument }
    result_double: procedure(Context: TSQLite3FunctionContext; Value: double); {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    result_blob: procedure(Context: TSQLite3FunctionContext; Value: Pointer;
      Value_bytes: Integer=0; DestroyPtr: TSQLDestroyPtr=SQLITE_TRANSIENT); {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    result_text: procedure(Context: TSQLite3FunctionContext; Value: PUTF8Char;
      Value_bytes: Integer=-1; DestroyPtr: TSQLDestroyPtr=SQLITE_TRANSIENT); {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    result_value: procedure(Context: TSQLite3FunctionContext; Value: TSQLite3Value); {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    result_error: procedure(Context: TSQLite3FunctionContext; Msg: PUTF8Char; MsgLen: integer=-1); {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    user_data: function(Context: TSQLite3FunctionContext): pointer; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    context_db_handle: function(Context: TSQLite3FunctionContext): TSQLite3DB; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    aggregate_context: function(Context: TSQLite3FunctionContext;
       nBytes: integer): pointer; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    bind_blob: function(S: TSQLite3Statement; Param: integer; Buf: pointer; Buf_bytes: integer;
      DestroyPtr: TSQLDestroyPtr=SQLITE_TRANSIENT): integer; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    bind_zeroblob: function(S: TSQLite3Statement; Param: integer; Size: integer): integer; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    bind_double: function(S: TSQLite3Statement; Param: integer; Value: double): integer; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    bind_int: function(S: TSQLite3Statement; Param: integer; Value: integer): integer; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    bind_int64: function(S: TSQLite3Statement; Param: integer; Value: Int64): integer; {$ifndef USEFASTCALL}cdecl;{$endif}

    {/ Bind a NULL Value to a parameter of a prepared statement
      - return SQLITE_OK on success or an error code - see SQLITE_* and sqlite3.errmsg()
      - S is a statement prepared by a previous call to sqlite3.prepare_v2()
      - Param is the index of the SQL parameter to be set (leftmost=1) }
    bind_null: function(S: TSQLite3Statement; Param: integer): integer; {$ifndef USEFASTCALL}cdecl;{$endif}

    {/ Reset All Bindings On A Prepared Statement }
    clear_bindings: function(S: TSQLite3Statement): integer; {$ifndef USEFASTCALL}cdecl;{$endif} 
    ...
    bind_parameter_count: function(S: TSQLite3Statement): integer; {$ifndef USEFASTCALL}cdecl;{$endif} 
    ...
    blob_open: function(DB: TSQLite3DB; DBName, TableName, ColumnName: PUTF8Char;
      RowID: Int64; Flags: Integer; var Blob: TSQLite3Blob): Integer; {$ifndef USEFASTCALL}cdecl;{$endif}

    {/ Close A BLOB Handle }
    blob_close: function(Blob: TSQLite3Blob): Integer; {$ifndef USEFASTCALL}cdecl;{$endif}

    {/ Read Data From a BLOB Incrementally }
    blob_read: function(Blob: TSQLite3Blob; const Data; Count, Offset: Integer): Integer; {$ifndef USEFASTCALL}cdecl;{$endif}

    {/ Write Data To a BLOB Incrementally }
    blob_write: function(Blob: TSQLite3Blob; const Data; Count, Offset: Integer): Integer; {$ifndef USEFASTCALL}cdecl;{$endif}

    {/ Return The Size Of An Open BLOB }
    blob_bytes: function(Blob: TSQLite3Blob): Integer; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    set_authorizer: function(DB: TSQLite3DB; xAuth: TSQLAuthorizerCallback;
      pUserData: Pointer): Integer;   {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    update_hook: function(DB: TSQLite3DB; xCallback: TSQLUpdateCallback;
      pArg: pointer): pointer; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    {/ Count The Number Of Rows Modified
     ...
     meaningful. }
    changes: function(DB: TSQLite3DB): Integer; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    {/ Total Number Of Rows Modified
     ...
     meaningful. }
    total_changes: function(DB: TSQLite3DB): Integer; {$ifndef USEFASTCALL}cdecl;{$endif} 
    ...
    malloc: function(n: Integer): Pointer; {$ifndef USEFASTCALL}cdecl;{$endif}

    {/ Attempts to resize a prior memory allocation
     - should call native realloc() function, i.e. ReallocMem() in this unit }
    realloc: function(pOld: Pointer; n: Integer): Pointer; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    free_: procedure(p: Pointer); {$ifndef USEFASTCALL}cdecl;{$endif}

    /// Returns the number of bytes of memory currently outstanding (malloced but not freed)
    memory_used: function: Int64; {$ifndef USEFASTCALL}cdecl;{$endif}

    /// Returns the maximum value of sqlite3.memory_used() since the high-water mark
    // was last reset
    memory_highwater: function(resetFlag: Integer): Int64; {$ifndef USEFASTCALL}cdecl;{$endif}
    ...
    trace: function(DB: TSQLite3DB; tCallback: TSQLTraceCallback;
      aUserData: Pointer): Pointer; {$ifndef USEFASTCALL}cdecl;{$endif}
  end;
...
function sqlite3.profile(DB: TSQLite3DB; pCallback: TSQLProfileCallback;
...
begin
  ...
  if Assigned(sqlite3.key) and (fPassword<>'') and
     (fFileName<>':memory:') and (fFileName<>'') then 
...
begin
  if cardinal(Col)>=cardinal(FieldCount) then
    raise ESQLite3Exception.Create(RequestDB, SQLITE_RANGE);
  result := Utf8DecodeToRawUnicode(sqlite3.column_text(Request,Col),0);
end;
...
const
  ...
  ('initialize','shutdown','open','key','rekey','close','libversion',
   ...
   'commit_hook','rollback_hook','changes','total_changes','malloc',
   'realloc','free','memory_used','memory_highwater','trace');
...
begin
  ...
  {$else}
  SynSQLite3Log.Add.Log(sllInfo,'Loaded external % version %',
    [LibraryName,libversion]);
  {$endif}
  {$endif}
end;
