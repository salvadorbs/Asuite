...
const
  ...
  TYPES: array[-1..high(PCHARS)] of TSQLDBDefinition = (
    dDefault,dOracle,dMSSQL,dJet,dMySQL,dSQLite,dFirebird,dFirebird);
begin
  Log := SynDBLog.Enter;
...
retry:      VData := CurrentAnsiConvert.UTF8ToAnsi(VData);
        ...
        status := ODBC.BindParameter(fStatement, p+1, InputOutputType, ValueType,
          ValueType, ColumnSize, 0, ParameterValue, ColumnSize, StrLen_or_Ind);
