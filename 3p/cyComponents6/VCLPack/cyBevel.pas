...
uses VCL.cyTypes, VCL.cyClasses, Windows, Graphics, ExtCtrls, classes, Messages, Controls;
...
procedure TcyCustomBevel.CmMouseEnter(var Msg: TMessage);
begin
  inherited;
  if Assigned(FOnMouseEnter) then FOnMouseEnter(Self);
end;

procedure TcyCustomBevel.CmMouseLeave(var Msg: TMessage);
begin
  inherited;
